...
- They upload the amount of time they spend on each project and shows on a GitHub-style Calender when completed
- Reports are automatically generated to show much of the allowed / quoted time has already been used
- Some users / employees have Admin-right, which allows them to:
